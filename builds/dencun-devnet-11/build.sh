...
# build_image "etb-all-clients-minimal:dencun-devnet-11" "etb-all-clients_minimal.Dockerfile"

# log_step "building all minimal instrumented clients"
# build_image "etb-all-clients-minimal-inst:dencun-devnet-11" "etb-all-clients_minimal-inst.Dockerfile"
