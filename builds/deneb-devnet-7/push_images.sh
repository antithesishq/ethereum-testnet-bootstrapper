...
docker tag "$ETB_ALL_CLIENTS:latest" "$CONTAINER_REPOSITORY/$ETB_ALL_CLIENTS:$TAG"
docker tag "$ETB_ALL_CLIENTS_INST:latest" "$CONTAINER_REPOSITORY/$ETB_ALL_CLIENTS_INST:$TAG"
